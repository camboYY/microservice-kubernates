...
import com.easybytes.cards.Config.CardsConfiguration;
...
public class CardsController {
    ...
    private final CardsConfiguration cardsConfiguration;
    @Value("${build.version}")
    private String buildVersion;

    public CardsController(Environment environment, ICardsService iCardsService, CardsConfiguration cardsConfiguration) {
    ...
    public ResponseEntity<CardsConfiguration> getBuildInfo() {
        return ResponseEntity.status(HttpStatus.OK).body(cardsConfiguration);
    }
